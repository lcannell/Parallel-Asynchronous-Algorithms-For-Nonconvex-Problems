FLEXA[1] for the solution of the Nesterov's LASSO problem[2]: find x which minimizes ||Ax-b||_2^2 + lambda*||x||_1; where: lambda > 0, A has m rows and n columns.
[1] Facchinei, Scutari, Sagratella "Parallel Selective Algorithms for Nonconvex Big Data Optimization", IEEE TRANSACTIONS ON SIGNAL PROCESSING, 2015.
