...
int main (int argc, char **argv) {	
	...
	for(int realization = 1; realization <= number_of_realizations; realization++){			
		...
		double entry = 0.0, f_star = 0.0, f_value = 0.0, f_value_old = 0.0, m_value = 0.0, hds_local = 0.0, hds_global = 0.0, prox =0.0;
		...
		data = "data/"+instance_stream.str()+"/xs.dat";
		file = fopen(data.c_str(), "r");
